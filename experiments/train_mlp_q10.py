...
class MLP(vg.Module):
    ...
    def forward(self, input):
        ...
        #extra layer
        hidden_l3 = self.layer3(hidden)
        
        hidden_l3 = vg.sigmoid(hidden_l3)
        
        # second layer
        output = self.layer2(hidden_l3)
    ...
    def parameters(self):
        ...
        return self.layer1.parameters() +self.layer3.parameters() +self.layer2.parameters()
