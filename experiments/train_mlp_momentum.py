...
#added momentum
momentum = {parm: np.zeros_like(parm.value) for parm in mlp.parameters()}
momentum_factor = 0.9  
...
for epoch in range(args.epochs):
    ...
    for fr in range(0, n, b):
        ...
        for parm in mlp.parameters():
            update = args.lr * parm.grad
            momentum[parm] = momentum_factor * momentum[parm] + update
            parm.value -= momentum[parm]
